...
def task_generate_report(**kwargs):
    ...
    try:
        ...
        context = {
            ...
            "total_country_metric": total_country_metric,
            "nas_storages": nas_metrics,
            "total_nas_storage": total_nas_metrics,
            "vm_utilization": vm_utilization_by_region,
            "avg_vm_utilization": avg_vm_utilization_country,
            "top15_vnf_cpu_p95_country": top15_vnf_cpu_p95_country.to_dict(orient="records"),
